...
# Description
# Samuel's grafted cutout jobs didn't turn out amazingly. Today I run six strand removal jobs and
# 2 of my 8 armstrong sphere's as a check. 8 jobs in total
...
#SBATCH -o strategy1_run_0504_%j.out
#SBATCH -e strategy1_run_0504_%j.out
...
for job_id in $(seq $job_start $job_end); do
    config_path="${config_base}_${job_id}.yml"
    report_output="${report_base}_${job_id}_0804.html"
    work_dir="/tmp/snakemake_job_${job_id}_$$"
